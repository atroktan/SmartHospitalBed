...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <div className="flex flex-col lg:flex-row justify-center items-center py-2 px-4 lg:px-12 gap-0">
        <div className="w-1/2 max-w-md">
          <img src={doctorImage} alt="Doctor" className="w-full h-30 rounded-md shadow-md object-cover" />
        </div>
        ...
        <div className="w-full max-w-lg bg-white p-8 rounded-xl shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="acceptTerms" className="text-sm text-gray-700">I accept <a href="#" className="text-blue-600">terms and conditions</a></label>
            </div>
